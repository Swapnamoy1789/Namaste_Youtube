...
const Head = () => {
  ...
  return (
    <div className="grid grid-flow-col p-5 m-2 shadow-lg relative z-20">
      {/* Menu and Logo */}
      ...
      <div className="col-span-10 px-10 relative">
        ...
        {showSuggestions && (
          <div
            className="absolute bg-white py-2 px-2 w-1/2 shadow-lg rounded-lg border border-gray-100 z-50 max-h-60 overflow-y-auto"
            style={{ top: "100%" }}
          >
            <ul>
              {suggestions.map((s) => (
